...
echo "✅ Setup Complete!"
echo ""
echo "🌊 Wave 3 Integration Enabled:"
echo "   Wazuh will forward high-severity alerts (rule 100006, level >= 8)"
echo "   to AI-SOC webhook: http://host.docker.internal:8000/api/threats/ingest/wazuh"
echo "   Note: Ensure AI-SOC is running to receive alerts"
echo ""
echo "📱 Next Steps:"
...
echo "   5. Verify alerts forwarded to AI-SOC"
echo ""
echo "🧪 Test the setup:"
